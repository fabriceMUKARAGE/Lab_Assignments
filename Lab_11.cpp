...
/*
Class for the rectBlocks which will that all blocks from the file called dataBlocks.dat
and it is also the base class
*/
int* NumbersArray = new int[60];  // this array will keep all numbers from the file
class rectBlocks {
public:
    void MyrectBlocks() {
...
public:
    void MycylindricalBlock() {
        ...
        // variables called temp to swap the diameter, height, and surface Area when sorting the values on ascending order
        double temp1;
        double temp2;
        double temp3;
        ...
        // for loop to take the diameter, height, and surface area for every cylinderical block in their arrays
        for (int i = 0; i < 60; i++) {
